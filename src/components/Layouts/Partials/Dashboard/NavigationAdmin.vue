	...
	<div>
		<div
			...
			<ul class="nav flex-column text-white w-100">
				<a href="/dashboard/admin" class="nav-link h3 text-white my-2">
					<Logo/> <span class="brand"> {{ brand }} </span>
				</a>
				<!-- <li class="nav-link">
					<router-link style="text-decoration: none; color:#fff;" to="/login"><i class="fas fa-users fa-fw"></i> <span class="mx-2">List User</span></router-link>
				</li> -->
				<li class="nav-link">
				...
				<li class="nav-link">
					<a style="text-decoration: none; color:#fff;" href="#" @click="Logout"><i class="fas fa-fw fa-sign-in-alt fa-fw"></i> <span class="mx-2">Logout</span></a>
				</li>
				<li class="nav-link">
